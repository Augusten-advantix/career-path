        ...
        <div className="min-h-screen bg-[#050505] flex">
            ...
            `}>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {!collapsed && (
                            <div className="overflow-hidden">
                                <h1 className="text-white font-semibold text-lg whitespace-nowrap tracking-tight">CareerPath</h1>
                ...
                <div className="p-3 border-t border-white/5 space-y-2">
                    <Link
                        to="/"
                        className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 transition-colors ${collapsed ? 'justify-center' : ''}`}
                    ...
                    <button
                        ...
                        className={`hidden lg:flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 transition-colors w-full ${collapsed ? 'justify-center' : ''}`}
                    >
                    ...
                    <div className="flex items-center justify-between px-4 lg:px-6 py-3">
                        ...
                        <div className="flex items-center gap-2 lg:gap-4">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-3 lg:px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 hover:text-white rounded-lg transition-all text-sm font-medium"
                            >
