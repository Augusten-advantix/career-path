        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
            ...
            <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-3xl mx-auto mb-12 px-2">
                        {/* Worker Card */}
                        <div
                            onClick={() => handleRoleSelection('worker')}
                            className={`relative p-6 sm:p-8 rounded-xl sm:rounded-2xl border-2 transition-all cursor-pointer group ${selectedRole === 'worker'
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform text-2xl sm:text-3xl">
                                    📈
                                </div>

                                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">For Job Seekers</h3>

                                <ul className="text-left space-y-2 sm:space-y-3 mb-4 sm:mb-6 text-slate-300 text-sm sm:text-base">
                                ...
                                <button
                                    ...
                                    className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 disabled:opacity-50 py-2.5 sm:py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition text-sm sm:text-base"
                                >
                        ...
                        <div
                            ...
                            className={`relative p-6 sm:p-8 rounded-xl sm:rounded-2xl border-2 transition-all cursor-pointer group ${selectedRole === 'recruiter'
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform text-2xl sm:text-3xl">
                                    👥
                                </div>

                                <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">For Recruiters</h3>
                                ...
                                <button
                                    ...
                                    className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 py-2.5 sm:py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition text-sm sm:text-base"
                                >
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 px-2">
                        {[
                            ...
                            <div key={idx} className="p-4 sm:p-6 rounded-lg bg-slate-700/50 border border-slate-600 hover:border-slate-500 transition">
            ...
            <footer className="border-t border-slate-700 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="border-t border-slate-700 pt-8 flex flex-col sm:flex-row justify-between items-center gap-2 text-slate-400 text-xs sm:text-sm">
