...
export const generateJobQuestion = async (conversationHistory: any[], answers?: any) => {
    ...
    const availability = answers?.availableHoursPerWeek ? `Candidate available hours/week: ${answers.availableHoursPerWeek}` : 'Availability not provided';
    const prompt = `
